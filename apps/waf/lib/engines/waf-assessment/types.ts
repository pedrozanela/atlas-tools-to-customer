...
export type WafRecommendationStatus = "pending" | "running" | "completed" | "failed";
export type WafRecommendationSetupStatus = "not_started" | "running" | "completed" | "failed";

export interface WafRecommendationEvidence {
  callId: string;
  title: string | null;
  sql: string | null;
  output: string | null;
...
export interface WafGenieRecommendation {
  id: string;
  assessmentId: string;
  wafId: string;
  agentId: string;
  status: WafRecommendationStatus;
  conversationId: string | null;
  responseId: string | null;
  reportMarkdown: string | null;
  citations: string[];
  documentationUrls: string[];
  evidence: WafRecommendationEvidence[];
  queryCount: number;
...
export type WafRecommendationBatchStatus =
  | "not_started"
  | "pending"
  | "running"
  | "completed"
...
export interface WafRecommendationBatch {
  assessmentId: string;
  status: WafRecommendationBatchStatus;
